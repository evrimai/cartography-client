...
<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/cartography.svg?label=pypi%20(stable))](https://pypi.org/project/cartography/)
...
pip install git+ssh://git@github.com/stainless-sdks/cartography-python.git
```

> [!NOTE]
> Once this package is [published to PyPI](https://www.stainless.com/docs/guides/publish), this will become: `pip install --pre cartography`
...
```sh
# install from this staging repo
pip install 'cartography[aiohttp] @ git+ssh://git@github.com/stainless-sdks/cartography-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/cartography-python/tree/main/src/cartography/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/cartography-python/tree/main/src/cartography/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/cartography-python/issues) with questions, bugs, or suggestions.
